...
; Overridable from CI: iscc /DAppVersion=0.5.0 (falls back to this for local builds).
#ifndef AppVersion
...
; Use the launcher icon generated by flutter_launcher_icons (committed, always present).
#define IconFile "..\..\apps\peerbeat\windows\runner\resources\app_icon.ico"
